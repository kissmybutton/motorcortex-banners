...
var BannerA = /*#__PURE__*/function (_MotorCortex$API$Clip) {
  _inherits(BannerA, _MotorCortex$API$Clip);
...
var src = {
  ...
  incidents: [{
    ...
    name: "BannerA" // attributesValidationRules: { animatedAttrs }
